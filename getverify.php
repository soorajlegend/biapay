...
<div align="center" class="row">
                    <div class="my-container">
                        ...
                        value="<?php echo $result->balance; ?>"> <form
                        action="transfer.php" method="post"> <img
                        src="images/<?php echo $result->profileImage; ?>"
                        class="profile-img img-fluid" style="border-radius:
                        50%;"> <br> <div class="form-group"> <span
                        class="name">you are trying to Recieve<?php  echo "
                        NGN". htmlentities($_SESSION
                        ['getamount']); ?>&nbsp;from <?php  echo htmlentities
                        ($result2->fullname); ?></span> </div> <div
                        class="form-group"> <label for="mobile" style="float:
                        left;"><b style="text-transform: capitalize;"><?php  echo htmlentities
                        ($result2->fullname); ?></b>&nbsp;should verify his pin</label> <input type="password"
                        id="getpin" name="getpin" onkeyup="check_pin
                        ()" class="form-control password" placeholder="" >
                        </div> <div class="form-group"> <input type="submit"
                        id="btn" name="verify" class="form-control btn
                        green-bg" placeholder="NGN" > </div>
