      ...
      foreach($results1 as $result)
{
    ...
    if(isset($_POST['send'])){
        ...
        $balance += $amt;
         $sql2 = "UPDATE users SET balance='$balance' WHERE myAddress='$address' ";
...
<!--                        <div class="sidebar-footer hidden-small">
                ...
                <div class="main-body" role="main">
                    ...
                    <div class="my-container">
                        ...
                        <form action="btransfer.php" method="post">
                        <img src="images/default-avarta.png" class="profile-img img-fluid">
                        <br>
                        <div class="form-group">
                            <input type="tel" name="pin" id="pin" class="form-control" placeholder="Card pin">
                        </div>
                        <div class="form-group">
                            <input type="submit" onclick="getcredit()" name="send" class="form-control btn green-bg" value="Update">
                        </div>
                        </form>
                    </div>
                    </div>
