      ...
      foreach($results1 as $result)
{
    ...
    if (isset($_POST['send'])) {
       ...
       $_SESSION['getamount'] = "$getamount";
       echo "<script>window.location.replace('getverify.php');</script>";
...
<div align="center" class="row">
                    <div class="my-container">
                        ...
                        <div class="form-group">
                            <span class="name"><?php  echo htmlentities($result2->fullname); ?></span>
                        </div>
                        <div class="form-group">
                        	<label for="mobile" style="float: left;">Amount</label>
                            <input type="text" id="getamount" name="getamount" onkeyup="check_balance()" class="form-control" placeholder="NGN" >
                        </div>
                        <div class="form-group">
                            <input type="submit" id="btn" name="send" class="form-control btn green-bg" placeholder="NGN" >
                        </div>
